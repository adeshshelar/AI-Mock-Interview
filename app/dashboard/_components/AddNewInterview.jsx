...
function AddNewInterview() {
  ...
  const onSubmit =async(e) => {
    ...
    const InputPrompt = "Job position: "+jobPosition+", job description: "+jobDesc+" , Years of experience :"+jobExperince+", Depends on this information please give me "+process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT+"interview questions with answered in Json format , Give question and answered as field in json"
    ...
    <div>
        ...
        <Dialog open={openDailog}>
            <DialogContent className='max-w-2xl'>
             <DialogHeader>
               <DialogTitle className='text-2xl'>Tell us more about your job interview
               </DialogTitle>
            <DialogDescription>
              <form onSubmit={onSubmit}>
                <div>
                  ...
                  <div className='my-3'>
                    ...
                    <Textarea placeholder='Ex. React, Express, MySql, NodeJS etc.'  required
